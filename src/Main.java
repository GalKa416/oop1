public class Main {
    ...
    public static void Best(Gryffindor[] studentGryffindor) {
            ...
            if (sum1 > sum2) {
                ...
                System.out.println("Студент Gryffindor " + studentGryffindor[0].getName() + " " + studentGryffindor[0].getSurname() + " Лучший на факультете, его способности " + sum1 + "  это выше, чем у " + studentGryffindor[1].getName() + " " + studentGryffindor[1].getSurname() + " который имеет " + sum2 + " балла.");
                    ...
                    System.out.println("Студент Gryffindor " + studentGryffindor[1].getName() + " " + studentGryffindor[1].getSurname() + " Лучший на факультете, его способности " + sum1 + " это выше, чем у " + studentGryffindor[0].getName() + " " + studentGryffindor[0].getSurname() + " который имеет " + sum2 + " балла.");
    ...
    public static void Best(Hufflepuff[] studentHufflepuffs) {
        ...
        if (sum1 > sum2) {
            ...
            System.out.println("Студент Hufflepuff " + studentHufflepuffs[1].getName() + " " + studentHufflepuffs[1].getSurname() + " Лучший на факультете, его способности " + sum1 + " это выше, чем у " + studentHufflepuffs[0].getName() + " " + studentHufflepuffs[0].getSurname() + " который имеет " + sum2 + " балла.");
    ...
    public static void Best(Ravenclaw[] studentRavenclaws) {
        ...
        if (sum1 > sum2) {
            ...
            System.out.println("Студент Ravenclaw " + studentRavenclaws[1].getName() + " " + studentRavenclaws[1].getSurname() + " Лучший на факультете, его способности " + sum1 + " это выше, чем у " + studentRavenclaws[0].getName() + " " + studentRavenclaws[0].getSurname() + " который имеет " + sum2 + " балла.");
    ...
    public static void Best(Slytherin[] studentSlytherin) {
        ...
        if (sum1 > sum2) {
            ...
            System.out.println("Студент Slytherin " + studentSlytherin[1].getName() + " " + studentSlytherin[1].getSurname() + " Лучший на факультете, его способности " + sum1 + " это выше, чем у " + studentSlytherin[0].getName() + " " + studentSlytherin[0].getSurname() + " который имеет " + sum2 + " балла.");
